      ...
      if (field.value.trim() === "") {
        ...
        if (field.type == "password") {
          if (field.value.length < 8) {
            this.setStatus(field, "".concat(field.previousElementSibling.innerText, " must be at least 8 characters"), "error");
            return false;
          } else {
...
//# sourceMappingURL=/login.54673263.js.map